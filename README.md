...
> [!IMPORTANT]
> Exploiters usually hide their scripts menus inside the `CoreGui` because Roblox strictly blocks developers from accessing it. Despite this limit, this AntiCheat uses a **clever and unique method** to detect any scripts hiding in the CoreGui.
